...
| Cargo/snow | 0.10.0 | `599b506ccc4aff8cf7844bc42cf783009a434c1e26c964432560fb6d6ad02d82` | Exact `Noise_XX_25519_ChaChaPoly_BLAKE2s` BLE session handshake and transport | critical | Apache-2.0 | Exact suite and feature set pinned; three-message transcript, ordered prologue, encrypted-frame sequence, mutation and redaction tests; advisory/license gates pass | conditional — external protocol/crypto interoperability review required before release | automated crypto review / 2026-06-30 |
